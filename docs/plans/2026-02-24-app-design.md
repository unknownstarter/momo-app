...
프로그레스 바: 5캐릭터 아이콘이 하나씩 채워지는 형태.

| Step | 가이드 캐릭터 | 입력 항목 | 캐릭터 대사 예시 |
|------|-------------|-----------|----------------|
| 1 | 물결이 🌊 | 이름, 성별, 생년월일 | "먼저 너에 대해 알려줘!" |
| 2 | 쇠동이 ⚡ | 태어난 시간 (선택) | "시간까지 알면 더 정확해져! 몰라도 괜찮아~" |
| 3 | 불꼬리 🔥 | 프로필 사진 1~6장 | "멋진 사진 보여줘! 인연이 기다리고 있어~" |
| 4 | 흙순이 🌍 | 한줄 소개 + 관심사 태그 | "어떤 사람인지 한마디로!" |

입력 완료 시 캐릭터 리액션: "좋아!", "완벽해!", "기대된다~"

### 3.3 사주 분석 전환 연출 (3~5초)

1. 나무리 🌿가 "좋아! 이제 네 사주를 볼게~"
2. 5캐릭터가 원형으로 배치, 빙글빙글 회전 + 오행 에너지 이펙트
3. 하나씩 사라지며 **내 오행 캐릭터만** 남음
4. 캐릭터 점프 등장: "찾았다! 네 사주를 봤어!"
5. 사주 결과 카드로 전환
