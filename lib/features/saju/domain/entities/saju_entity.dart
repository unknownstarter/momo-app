...
// 궁합(Compatibility)은 사주/매칭 양쪽 feature에서 사용하는 공유 도메인 개념이므로
// core/domain/entities/에 정의하고 여기서 re-export합니다.
// 기존 import 호환성을 유지하면서 clean architecture 위반을 해소합니다.
export '../../../../core/domain/entities/compatibility_entity.dart';
